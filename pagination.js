$.fn.dataTableExt.oPagination.simple_incremental_bootstrap = {
    ...
    "fnInit": function (oSettings, nPaging, fnCallbackDraw) {
        ...
        nFirst.className = "paginate_button first active btn btn-primary";
        nPrevious.className = "paginate_button previous btn btn-primary";
        nNext.className = "paginate_button next btn btn-primary";
